...
void SimpleShadowmapRender::SetupGUIElements()
{
  ...
  ImGui::NewFrame();
  {
    ...
    ImGui::Checkbox("SSS", (bool*)&m_uniforms.sss);
    ImGui::SliderFloat("SSS scale", &m_uniforms.sssScale, 0.5f, 40.0f, NULL, ImGuiSliderFlags_AlwaysClamp);
